	...
	$.pluginFactory({
		...
		priv: {
			...
			createEditor: function(callback) {
				...
				var browserPlugin = $.browser.mozilla ? 'Gecko' :
					$.browser.webkit ? 'WebKit' :
					$.browser.msie ? 'InternetExplorer' :
					undefined;
				editor.registerPlugins($.merge(browserPlugin ? [browserPlugin] : [], ['GetHtmlImplementation', 'CreateLink', 'InsertImage']));
...
//					});
			...
			getSelectionState: function(key) {
				...
				// TODO: Implement for MSIE and WebKit.
